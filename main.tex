...
% --- AYUDAS DE MAQUETACIÓN SEGÚN TIPO DE RECETA ---
\newcommand{\recetaCompacta}[1]{%
    \input{#1}%
}

\newcommand{\recetaCompactaSeparada}[1]{%
    \clearpage
    \input{#1}%
}
...
\recetaCompacta{secciones/entrantes/guacamole.tex}
\recetaCompactaSeparada{secciones/entrantes/salmorejo.tex} 
...
\chapter{Postres}
\recetaCompacta{secciones/postres/mousse_limon.tex}
