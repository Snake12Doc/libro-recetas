\nuevaReceta{Salmorejo}{20 min (+ frío)}{receta:salmorejo}

    % --- AÑADIR FOTO ---
    \begin{center}
        \includegraphics[width=0.68\textwidth, angle=0]{imagenes/salmorejo.png} 
        \\ \vspace{0.3em}
        \small \textit{No ha sido mi mejor resultado, ¡pero un sabor increíble!} 
    \end{center}
    \vspace{0.5em}
