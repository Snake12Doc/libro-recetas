\nuevaReceta{Mousse de Limón}{10 min (+ frío)}{receta:mousse_limon}

    % --- AÑADIR FOTO ---
    \begin{center}
        \includegraphics[width=0.66\textwidth, angle=0]{imagenes/mousse_limon.png}
        \\ \vspace{0.3em}
        \small \textit{Fresquita, cremosa y con ese toque de limón que entra solo.}
    \end{center}
    \vspace{0.5em}
    ...
    \begin{minipage}[t]{0.35\textwidth}
        ...
        \begin{itemize}[leftmargin=*]
            ...
            \item 1 bote de leche condensada
