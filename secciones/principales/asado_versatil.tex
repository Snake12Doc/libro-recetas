\nuevaReceta{Asado al Horno (Carne o Pescado)}{4 personas}{1 h 20 min}{receta:asado_versatil}
    
    \begin{minipage}[t]{0.35\textwidth}
        \section*{Ingredientes}
        \begin{itemize}[leftmargin=*]
            \item \textbf{Base:} 1 kg de patatas, 1 cebolla, 2 tomates y 1 pimiento rojo.
            \item \textbf{Grasa:} 30 g de mantequilla.
            \item \textbf{Líquido:} 150 ml de vino blanco.
            \item \textbf{Proteína recomendada:} 800 g de entraña, costillar, salmón o lubina.
            \item \textbf{Sazón:} Hierbas provenzales, ajo, perejil, sal y limón.
            \item \textbf{Extra opcional:} Especias barbacoa.
        \end{itemize}
    \end{minipage}
    \hfill
