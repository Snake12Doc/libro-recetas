\begin{receta}{Tacos de Entraña y Piña}{25 min}
    ...
    \vspace{1em}
    \begin{tcolorbox}[colback=orange!5, colframe=orange!50, title=Toque Extra, size=small]
        Añade una base de guacamole sobre la tortilla caliente antes de poner la carne para que queden más jugosos.
    \end{tcolorbox}
\end{receta}